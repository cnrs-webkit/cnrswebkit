<?php
/**
 * Template Name: CNRS WebKit list of news whitout sidebar
 * Template Post Type: post, page
 *
 * The template for displaying a list of new whitout sidebar
 *
 * @package Atos
...
__('CNRS WebKit list of news whitout sidebar', 'cnrswebkit');
