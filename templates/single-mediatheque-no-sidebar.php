<?php
/**
 * Template Name: CNRS WebKit media whitout sidebar
 * Template Post Type: mediatheque
 * 
 * The template for displaying CNRS WebKit media whitout sidebar
 *
 * @package Atos
...
__('CNRS WebKit media whitout sidebar', 'cnrswebkit');
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		while ( have_posts() ) : the_post();
			...
			get_template_part( 'template-parts/content', 'mediatheque' );
