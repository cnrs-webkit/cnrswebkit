<?php
/**
 * Template Name: CNRS WebKit event whitout sidebar
 * Template Post Type: evenement
 * 
 * The template for displaying CNRS WebKit event whitout sidebar
 *
 * @package Atos
...
__('CNRS WebKit event whitout sidebar', 'cnrswebkit');
