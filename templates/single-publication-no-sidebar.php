<?php
/**
 * Template Name: CNRS WebKit publication whitout sidebar
 * Template Post Type: publication
 * 
 * The template for displaying CNRS WebKit publication whitout sidebar
 *
 * @package Atos
...
__('CNRS WebKit publication whitout sidebar', 'cnrswebkit');
