<?php
/**
 * Template Name: CNRS WebKit job with sidebar
 * Template Post Type: emploi
 * 
 * The template for displaying CNRS WebKit job with sidebar
 *
 * @package Atos
...
__('CNRS WebKit job with sidebar', 'cnrswebkit');
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		while ( have_posts() ) : the_post();
			...
			get_template_part( 'template-parts/content', 'emploi' );
