<?php
/**
 * Template Name: CNRS WebKit publication with sidebar
 * Template Post Type: publication
 * 
 * The template for displaying CNRS WebKit publication with sidebar
 *
 * @package Atos
...
__('CNRS WebKit publication with sidebar', 'cnrswebkit');
