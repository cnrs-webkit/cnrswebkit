<?php
/**
 * Template Name: CNRS WebKit news with sidebar
 * Template Post Type: actualite
 *
 * The template for displaying CNRS WebKit single news with sidebar
 *
 * @package Atos
...
__('CNRS WebKit single news with sidebar', 'cnrswebkit');

get_header(); ?>

<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">CNRS WebKit single news with sidebar
		<?php
		// Start the loop.
