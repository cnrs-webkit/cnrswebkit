<?php
/**
 * Template Name: CNRS WebKit news whitout sidebar
 * Template Post Type: actualite
 * 
 * The template for displaying CNRS WebKit news whitout sidebar
 *
 * @package Atos
...
__('CNRS WebKit news whitout sidebar', 'cnrswebkit');
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">CNRS WebKit single news whitout sidebar
		<?php
		// Start the loop.
